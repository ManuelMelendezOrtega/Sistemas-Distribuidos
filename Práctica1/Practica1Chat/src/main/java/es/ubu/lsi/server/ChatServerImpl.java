 ...
 * 
 * Modified by Raul Marticorena and Joaquin P. Seco
 * 
...
public class ChatServerImpl implements ChatServer {
	...
	public synchronized void broadcast(ChatMessage message) {
		...
		String messageLf = "<Manuel> patrocina el mensaje: " + time + " " + message.getMessage() + "\n";
		...
		public void run() {
			...
			while (runningThread) {
				...
				case SHUTDOWN:
					...
					break;
				case MESSAGE:
					if (!chatMessage.getMessage().startsWith(username + " ha baneado a ")
							&& !chatMessage.getMessage().startsWith(username + " ha desbaneado a ")) {
